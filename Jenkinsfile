...
pipeline {
  ...
  environment {
      ...
      EMAIL_ADDRESS = 'alvarolinarescabre@gmail.com'
      REGISTRY = 'alvarolinarescabre/nodejs'
  }
  ...
  stages {
      ...
      stage('Checkout') {
        ...
        // Get Github repo using Github credentials (previously added to Jenkins credentials)
          checkout([$class: 'GitSCM', branches: [[name: '*/main']], extensions: scm.extensions, userRemoteConfigs: [[url: 'http://gitlab/root/chamo', credentialsId: 'gitlab']]])
        }
      }
